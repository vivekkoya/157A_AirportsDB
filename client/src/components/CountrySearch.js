...
export function CitySearch({ setCountryCode }, props) {
    const countries = [
        ...
        { "name": "Korea, Democratic People Republic", "code": "KP" },
    ...
    const handleCountryChange = changedItem => {
        const countryCode = getCountryCode(changedItem);
        setSelectedCountry(changedItem);
        setCountryCode(countryCode); // Call the callback function with the country code
    };
